...
export const changelog: ChangelogEntry[] = [
  {
    ...
    date: "2025-09-22",
    added: [
    "🎬 播放统计页面VideoCard观看更新显示系统：使用VideoCard组件替代弹窗显示观看更新，提供更直观的用户体验",
    "📊 播放统计页面双重提醒系统：新增"新剧集"和"继续观看"独立分类，红色主题显示新剧集更新，蓝色主题显示继续观看提醒",
    ...
    "🔧 播放统计页面测试按钮增强：为弹窗显示调试添加测试按钮，方便开发调试"
    ],
    changed: [
    "🔄 播放统计页面弃用弹窗式更新：完全移除基于弹窗的观看更新显示方式，改用VideoCard直接展示",
    ...
    fixed: [
    "🐛 修复播放统计页面管理员模式弹窗显示问题：确保弹窗在所有渲染分支（管理员/个人/加载状态）中正确显示",
    ...
    "🆔 修复播放统计页面API端点安全性：新增/api/sources端点，安全地向客户端暴露可用数据源，避免服务端代码导入错误"
    ]
  },
  {
    version: "5.4.3",
